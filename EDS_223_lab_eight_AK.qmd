...
- Locations of representative vegetation communities:
   ...
   - Polygons representing sites study_site: 
      - character string with plant type
...
Note: In Homework Assignment #4, you’ll be asked to generalize you’re workflow into a function that can be used to run analysis on multiple species. In this lab, we’ll see how to translate code into a generalized function.
...
DON'T RUN THIS CODE: Before diving into the detailed nuances of your function, it’s helpful to start by outlining the major steps you want your function to perform using pseudo-code.
...
Turning Psuedocode into Real Code
...
Note: Is there a way to improve this last step even further? Wrap it into a for loop? Could we pull the date strings directly from the file names?

# 5. Compare NDVI Across Vegetation Communities
...
## a) Get Data on Vegetation Communities
...
2. Turn from wide to long format
3. Turn layer names into date format
4. Combine study sites by vegetation type
5. Summarize results within vegetation types
...
Note: What do we notice in the seasonal cycle in NDVI across vegetation communities?
